onEvent('recipes', e => {
  ...
  e.custom({
      type: 'lazierae2:centrifuge', // aggregator centrifuge energizer etcher
      process_time: 160,
      energy_cost: 25000,
      output: {
  ...
  e.custom({
      type: 'lazierae2:aggregator', // aggregator centrifuge energizer etcher
      process_time: 80,
      energy_cost: 25000,
      output: {
  ...
  //ender pearl 2 ender pearl dust recipe
